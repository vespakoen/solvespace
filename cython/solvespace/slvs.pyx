...
from .slvs cimport EntityBase, hEntity

cdef class PyhEntity:
    cdef hEntity he
...
cdef class PyEntityBase:
    ...
    # @property
    # def point(self):
    #     return self.c_e.point
    # @point.setter
    # def point(self, point):
    #     self.c_e.point = point
    ...
    @property
    def workplane(self):
        return self.c_e.workplane.v
    @workplane.setter
    def workplane(self, workplane):
        self.c_e.workplane.v = workplane

    @property
    def group(self):
        return self.c_e.group.v
    @group.setter
    def group(self, group):
        self.c_e.group.v = group

    # @property
    # def params(self):
    #     return self.c_e.params
    # @params.setter
    # def params(self, params):
    #     self.c_e.params = params

    def has_vector(self):
        return self.c_e.HasVector()

    def is_3d(self):
        # return self.c_e.workplane == self.c_e.FREE_IN_3D
        return False
    ...
    def is_point_2d(self):
        # return self.c_e.t == SLVS_E_POINT_IN_2D
        return False

    def is_point_3d(self):
        return False

    def is_point(self):
        return False

    def is_normal_2d(self):
        return False

    def is_normal_3d(self):
        return False
...
#             return self.add_constraint(SLVS_C_PT_ON_CIRCLE, wp, 0., e1, _E_NONE, e2, _E_NONE)
#         else:
...
#             if wp is _E_FREE_IN_3D:
#                 raise ValueError("this is a 2d constraint")
#             arc_points = e1.points()
#             line_points = e2.points()
#             a2 = self.params(self.entity(arc_points[2] - 1).params)
#             l0 = self.params(self.entity(line_points[0] - 1).params)
#             l1 = self.params(self.entity(line_points[1] - 1).params)
#             other = 0
#             l0isa2 = l0[0] == a2[0] and l0[1] == a2[1]
#             l1isa2 = l1[0] == a2[0] and l1[1] == a2[1]
#             if l0isa2 or l1isa2:
#                 other = 1
#             return self.add_constraint(SLVS_C_ARC_LINE_TANGENT, wp, 0., _E_NONE, _E_NONE, e1, e2, _E_NONE, _E_NONE, other)
