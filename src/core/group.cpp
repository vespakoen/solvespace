...
//                        h.param(2), NO_PARAM, NO_PARAM, NO_PARAM, NO_PARAM, NO_PARAM,
//                        CopyAs::N_TRANS);
...
//         ExprQuaternion q = {Expr::From(h.param(3)), Expr::From(h.param(4)), Expr::From(h.param(5)),
//                             Expr::From(h.param(6))};
...
//         EntReqTable::GetEntityInfo(ep->type, ep->extraPoints, NULL, &points, &hasNormal,
//                                    &hasDistance);
//         for(i = 0; i < points; i++) {
...
//     return SS.explode && h == SS.GW.activeGroup && type == Type::DRAWING_WORKPLANE &&
//            !SS.exportMode;
// }
