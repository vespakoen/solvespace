...
PYBIND11_MODULE(slvs, m) {
    ...
    py::class_<Sketch<ConstraintBase, EntityBase>>(m, "Sketch")
        .def(py::init<>())
        .def("get_entity", &Sketch<ConstraintBase, EntityBase>::GetEntity,
             "Get an entity by it's handle", py::return_value_policy::reference)
        .def("get_constraint", &Sketch<ConstraintBase, EntityBase>::GetConstraint,
             "Get a constraint by it's handle", py::return_value_policy::reference)
        .def("get_param", &Sketch<ConstraintBase, EntityBase>::GetParam,
             "Get a param by it's handle", py::return_value_policy::reference)
        .def("params", py::overload_cast<>(&Sketch<ConstraintBase, EntityBase>::GetParams))
        .def("params",
             py::overload_cast<std::vector<hParam>>(&Sketch<ConstraintBase, EntityBase>::GetParams))
        .def("constraints", &Sketch<ConstraintBase, EntityBase>::GetConstraints)
        .def("entities", &Sketch<ConstraintBase, EntityBase>::GetEntities)
        .def_readwrite("group", &Sketch<ConstraintBase, EntityBase>::group)
        .def_readwrite("param", &Sketch<ConstraintBase, EntityBase>::param)
        .def_readwrite("entity", &Sketch<ConstraintBase, EntityBase>::entity)
        ...
        .def("add_normal_2d", &Sketch<ConstraintBase, EntityBase>::AddNormal2D)
        .def("add_normal_3d", &Sketch<ConstraintBase, EntityBase>::AddNormal3D)
        .def("add_distance", &Sketch<ConstraintBase, EntityBase>::AddDistance)
        .def("add_line_2d", &Sketch<ConstraintBase, EntityBase>::AddLine2D)
        .def("add_line_3d", &Sketch<ConstraintBase, EntityBase>::AddLine3D)
        .def("add_cubic", &Sketch<ConstraintBase, EntityBase>::AddCubic)
        .def("add_arc", &Sketch<ConstraintBase, EntityBase>::AddArc)
        .def("add_circle", &Sketch<ConstraintBase, EntityBase>::AddCircle)
        .def("add_workplane", &Sketch<ConstraintBase, EntityBase>::AddWorkplane)
        .def("create_2d_base", &Sketch<ConstraintBase, EntityBase>::Create2DBase)
        .def("add_constraint", &Sketch<ConstraintBase, EntityBase>::AddConstraint)
        .def("coincident", &Sketch<ConstraintBase, EntityBase>::Coincident)
        .def("distance", &Sketch<ConstraintBase, EntityBase>::Distance)
        .def("equal", &Sketch<ConstraintBase, EntityBase>::Equal)
        .def("equal_angle", &Sketch<ConstraintBase, EntityBase>::EqualAngle)
        .def("equal_point_to_line", &Sketch<ConstraintBase, EntityBase>::EqualPointToLine)
        .def("ratio", &Sketch<ConstraintBase, EntityBase>::Ratio)
        .def("symmetric", &Sketch<ConstraintBase, EntityBase>::Symmetric)
        .def("symmetric_h", &Sketch<ConstraintBase, EntityBase>::SymmetricH)
        .def("symmetric_v", &Sketch<ConstraintBase, EntityBase>::SymmetricV)
        .def("midpoint", &Sketch<ConstraintBase, EntityBase>::Midpoint)
        .def("horizontal", &Sketch<ConstraintBase, EntityBase>::Horizontal)
        .def("vertical", &Sketch<ConstraintBase, EntityBase>::Vertical)
        .def("diameter", &Sketch<ConstraintBase, EntityBase>::Diameter)
        .def("same_orientation", &Sketch<ConstraintBase, EntityBase>::SameOrientation)
        .def("angle", &Sketch<ConstraintBase, EntityBase>::Angle)
        .def("perpendicular", &Sketch<ConstraintBase, EntityBase>::Perpendicular)
        .def("parallel", &Sketch<ConstraintBase, EntityBase>::Parallel)
        .def("tangent", &Sketch<ConstraintBase, EntityBase>::Tangent)
        .def("distance_proj", &Sketch<ConstraintBase, EntityBase>::DistanceProj)
        .def("dragged", &Sketch<ConstraintBase, EntityBase>::Dragged)
        .def("length_diff", &Sketch<ConstraintBase, EntityBase>::LengthDiff)
        .def("clear", &Sketch<ConstraintBase, EntityBase>::Clear);
    ...
    py::class_<Group>(m, "Group")
        .def(py::init<>())
        .def_readwrite("allDimsReference", &Group::allDimsReference)
        .def_readwrite("relaxConstraints", &Group::relaxConstraints)
        // .def_readwrite("solved", &Group::solved)
        .def_readwrite("suppressDofCalculation", &Group::suppressDofCalculation)
        .def_readwrite("allowRedundant", &Group::allowRedundant)
        .def_readwrite("h", &Group::h)
